...
def main():
    ...
    project = "artifactsmmo"

    sdks = {
        "csharp": f"{__DIR}/examples/{project}/generated/csharp/src/OSEG.ArtifactsMMO/Examples",
        "java": f"{__DIR}/examples/{project}/generated/java/src/main/java/oseg/artifactsmmo/examples",
    ...
    oas_file = f"{__DIR}/examples/{project}/openapi.json"
