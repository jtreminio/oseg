...
begin
    response = ArtifactsMMOClient::MyCharactersApi.new.action_delete_item_my_name_action_delete_post(
        nil, // name
        simple_item_schema,
    )
    ...
    puts "Exception when calling MyCharacters#action_delete_item_my_name_action_delete_post: #{e}"
end
