...
begin
    response = ArtifactsMMOClient::MyCharactersApi.new.action_withdraw_bank_gold_my_name_action_bank_withdraw_gold_post(
        nil, // name
    ...
    puts "Exception when calling MyCharacters#action_withdraw_bank_gold_my_name_action_bank_withdraw_gold_post: #{e}"
end
