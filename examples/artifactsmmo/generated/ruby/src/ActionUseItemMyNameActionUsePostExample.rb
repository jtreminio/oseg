...
begin
    response = ArtifactsMMOClient::MyCharactersApi.new.action_use_item_my_name_action_use_post(
        nil, // name
        simple_item_schema,
    )
    ...
    puts "Exception when calling MyCharacters#action_use_item_my_name_action_use_post: #{e}"
end
