...
begin
    response = ArtifactsMMOClient::MyCharactersApi.new.action_withdraw_bank_my_name_action_bank_withdraw_post(
        nil, // name
        simple_item_schema,
    )
    ...
    puts "Exception when calling MyCharacters#action_withdraw_bank_my_name_action_bank_withdraw_post: #{e}"
end
