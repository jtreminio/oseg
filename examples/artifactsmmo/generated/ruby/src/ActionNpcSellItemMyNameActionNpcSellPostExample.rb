...
begin
    response = ArtifactsMMOClient::MyCharactersApi.new.action_npc_sell_item_my_name_action_npc_sell_post(
        nil, // name
    ...
    puts "Exception when calling MyCharacters#action_npc_sell_item_my_name_action_npc_sell_post: #{e}"
end
