...
const changePassword = new models.ChangePassword();
changePassword.currentPassword = undefined;
changePassword.newPassword = undefined;

apiCaller.changePasswordMyChangePasswordPost(
  changePassword,
).then(response => {
  console.log(response.body);
}).catch(error => {
  console.log("Exception when calling MyAccount#changePasswordMyChangePasswordPost:");
