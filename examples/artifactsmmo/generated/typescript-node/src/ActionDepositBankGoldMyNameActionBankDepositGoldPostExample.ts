...
apiCaller.actionDepositBankGoldMyNameActionBankDepositGoldPost(
  undefined, // name
  depositWithdrawGoldSchema,
).then(response => {
  console.log(response.body);
}).catch(error => {
  console.log("Exception when calling MyCharacters#actionDepositBankGoldMyNameActionBankDepositGoldPost:");
