...
apiCaller.actionWithdrawBankMyNameActionBankWithdrawPost(
  undefined, // name
  simpleItemSchema,
).then(response => {
  console.log(response.body);
}).catch(error => {
  console.log("Exception when calling MyCharacters#actionWithdrawBankMyNameActionBankWithdrawPost:");
