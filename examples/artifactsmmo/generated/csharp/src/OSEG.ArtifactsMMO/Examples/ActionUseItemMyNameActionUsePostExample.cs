...
public class ActionUseItemMyNameActionUsePostExample
{
    public static void Run()
    {
        ...
        try
        {
            var response = new MyCharactersApi(config).ActionUseItemMyNameActionUsePost(
                name: null,
        ...
        {
            Console.WriteLine("Exception when calling MyCharacters#ActionUseItemMyNameActionUsePost: " + e.Message);
