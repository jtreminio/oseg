...
public class ActionTaskTradeMyNameActionTaskTradePostExample
{
    public static void Run()
    {
        ...
        try
        {
            var response = new MyCharactersApi(config).ActionTaskTradeMyNameActionTaskTradePost(
                name: null,
        ...
        {
            Console.WriteLine("Exception when calling MyCharacters#ActionTaskTradeMyNameActionTaskTradePost: " + e.Message);
