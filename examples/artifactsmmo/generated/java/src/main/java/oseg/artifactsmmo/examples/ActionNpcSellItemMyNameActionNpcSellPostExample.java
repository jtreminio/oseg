...
public class ActionNpcSellItemMyNameActionNpcSellPostExample
{
    public static void main(String[] args)
    {
        ...
        npcMerchantBuySchema.code(null);
        npcMerchantBuySchema.quantity(null);

        try
        {
            var response = new MyCharactersApi(config).actionNpcSellItemMyNameActionNpcSellPost(
                null, // name
            ...
            System.err.println("Exception when calling MyCharacters#actionNpcSellItemMyNameActionNpcSellPost");
