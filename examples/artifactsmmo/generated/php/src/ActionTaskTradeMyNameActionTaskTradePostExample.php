...
try {
    $response = (new ArtifactsMMO\Client\Api\MyCharactersApi(config: $config))->actionTaskTradeMyNameActionTaskTradePost(
        name: null,
    ...
    echo "Exception when calling MyCharacters#actionTaskTradeMyNameActionTaskTradePost: {$e->getMessage()}";
}
