...
try {
    $response = (new ArtifactsMMO\Client\Api\MyCharactersApi(config: $config))->actionNpcSellItemMyNameActionNpcSellPost(
        name: null,
    ...
    echo "Exception when calling MyCharacters#actionNpcSellItemMyNameActionNpcSellPost: {$e->getMessage()}";
}
