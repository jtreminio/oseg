...
try {
    $response = (new ArtifactsMMO\Client\Api\MyCharactersApi(config: $config))->actionDeleteItemMyNameActionDeletePost(
        name: null,
    ...
    echo "Exception when calling MyCharacters#actionDeleteItemMyNameActionDeletePost: {$e->getMessage()}";
}
