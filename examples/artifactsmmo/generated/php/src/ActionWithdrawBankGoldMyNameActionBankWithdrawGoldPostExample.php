...
try {
    $response = (new ArtifactsMMO\Client\Api\MyCharactersApi(config: $config))->actionWithdrawBankGoldMyNameActionBankWithdrawGoldPost(
        name: null,
    ...
    echo "Exception when calling MyCharacters#actionWithdrawBankGoldMyNameActionBankWithdrawGoldPost: {$e->getMessage()}";
}
