...
"""
Output: https://github.com/jtreminio/oseg-examples/tree/main/namsor
"""
...
def main():
    ...
    sdks = {
        "csharp": {
            ...
            "output_dir": "src/OSEG.NamsorExamples",
        },
        "java": {
            "base_dir": f"{project_dir}/java",
            "output_dir": "src/main/java/oseg/namsor_examples",
        },
        "kotlin": {
            "base_dir": f"{project_dir}/kotlin",
            "output_dir": "src/main/kotlin/oseg/namsor_examples",
        },
        "php": {
