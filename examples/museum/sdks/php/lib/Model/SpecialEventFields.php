...
/**
 * SpecialEventFields Class Doc Comment
 *
 * @category Class
 * @package  OpenAPIMuseum\Client
 * @author   OpenAPI Generator team
 ...
 */
class SpecialEventFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpecialEventFields';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name of the special event.
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string|null $location Location where the special event is held.
     *
     * @return self
     */
     ...
     *
     * @param string|null $event_description Description of the special event.
     *
     * @return self
     */
     ...
     * Sets dates
     *
     * @param \DateTime[]|null $dates List of planned dates for the special event.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float|null $price Price of a ticket for the special event.
     *
     * @return self
     */
