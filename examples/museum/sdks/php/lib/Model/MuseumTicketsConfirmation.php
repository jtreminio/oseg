...
/**
 * MuseumTicketsConfirmation Class Doc Comment
 *
 * @category Class
 ...
 */
class MuseumTicketsConfirmation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MuseumTicketsConfirmation';
    ...
    */
     ...
     * Sets message
     *
     * @param string $message Confirmation message after a ticket purchase.
     *
     * @return self
     */
     ...
     *
     * @param string $confirmation_code Unique confirmation code used to verify ticket purchase.
     *
     * @return self
     */
