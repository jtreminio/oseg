...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "MuseumPlaceholderAuth": BasicAuthSetting,
    },
    total=False,
)
...
conf = openapimuseum_client.Configuration(
    username='the-user',
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://redocly.com/_mock/docs/openapi/museum-api" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("openapimuseum_client")
