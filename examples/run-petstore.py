...
"""
Output: https://github.com/jtreminio/oseg-examples/tree/main/petstore
"""
...
def main():
    ...
    sdks = {
        "csharp": {
            ...
            "output_dir": "src/OSEG.PetStoreExamples",
        },
        "java": {
            "base_dir": f"{project_dir}/java",
            "output_dir": "src/main/java/oseg/petstore_examples",
        },
        "kotlin": {
            "base_dir": f"{project_dir}/kotlin",
            "output_dir": "src/main/kotlin/oseg/petstore_examples",
        },
        "php": {
    ...
    oas_file = f"{project_dir}/openapi.yaml"
