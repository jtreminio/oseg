...
/**
 * SpecialEvent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPIMuseum\Client
 * @author   OpenAPI Generator team
 ...
 */
class SpecialEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpecialEvent';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Name of the special event.
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string $location Location where the special event is held.
     *
     * @return self
     */
     ...
     *
     * @param string $event_description Description of the special event.
     *
     * @return self
     */
     ...
     * Sets dates
     *
     * @param \DateTime[] $dates List of planned dates for the special event.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float $price Price of a ticket for the special event.
     *
     * @return self
     */
