  ...
  class MuseumTicketsConfirmation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiMuseumClient::MuseumTicketsConfirmation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiMuseumClient::MuseumTicketsConfirmation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ticket_date')
        self.ticket_date = attributes[:'ticket_date']
      else
        self.ticket_date = nil
      end
    ...
    def list_invalid_properties
      ...
      if @ticket_date.nil?
        invalid_properties.push('invalid value for "ticket_date", ticket_date cannot be nil.')
      end

      if @ticket_type.nil?
        invalid_properties.push('invalid value for "ticket_type", ticket_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ticket_date.nil?
    ...
    def hash
      [ticket_id, ticket_date, ticket_type, event_id, message, confirmation_code].hash
    end
