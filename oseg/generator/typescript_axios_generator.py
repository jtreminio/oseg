...
class TypescriptAxiosConfig(generator.BaseConfig):
...
class TypescriptAxiosGenerator(generator.BaseGenerator):
    CONFIG_CLASS = TypescriptAxiosConfig
    ...
    def _handle_value(
        ...
        if item.is_enum:
            ...
            final = f"api.{parent_type}{enum_type}.{enum_name}"
...
generator.GeneratorFactory.register(TypescriptAxiosGenerator)
