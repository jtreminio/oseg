...
TypescriptFetchConfigDef = TypedDict(
    "TypescriptFetchConfigDef",
    {
        "npmName": str,
...
class TypescriptFetchConfigComplete(TypedDict):
    npmName: str
    additionalProperties: TypescriptFetchConfigDef


@dataclass
class TypescriptFetchConfigOseg(generator.BaseConfigOseg):
    npmName: str | None


class TypescriptFetchConfig(generator.BaseConfig):
    GENERATOR_NAME = "typescript-fetch"
    oseg: TypescriptFetchConfigOseg
    ...
    def __init__(self, config: TypescriptFetchConfigDef):
        self._config = config

        self.npmName = config.get("npmName")
        assert isinstance(self.npmName, str)

        self.oseg = TypescriptFetchConfigOseg(
...
class TypescriptFetchGenerator(generator.BaseGenerator):
    FILE_EXTENSION = "ts"
...
class TypescriptFetchProject(generator.ProjectSetup):
    config: TypescriptFetchConfig
